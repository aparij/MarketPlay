...
def find_events_below_X(ls_symbols, d_data, X):
...
def e_profiler(dt_start, dt_end, year, price):
    ...
    df_events = find_events_below_X(ls_symbols, d_data, price)
...
if __name__ == '__main__':
    ...
    dt_start = dt.datetime(2008, 1, 1)
    dt_end = dt.datetime(2009, 12, 31)
    e_profiler(dt_start, dt_end, "2012", 8)
